...
# NEW: Import the required libraries from Flask
...
# NEW: Initialize the Flask application
app = Flask(__name__)
...
# --- Your existing function is kept, but it will be called by an API endpoint now ---
def fetch_and_insert_news():
    ...
    try:
        ...
        if articles_to_insert:
            print(f"Inserting {len(articles_to_insert)} new articles into Supabase...")
...
# NEW: This block runs the Flask web server
